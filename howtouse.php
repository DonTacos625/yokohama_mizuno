				...
				<div class="contentswrap">
					...
					<div id="1">
						...
						<div id="11">
							...
							<ol>
								...
								<li>登録完了後、自動的に<a href="#2">会員詳細情報編集</a>ページへ遷移する</li>
							</ol>
							<h3>SNSを使わずにログイン</h3>
							<ol>
								<li>ページ上部の項目「ログイン」を押す</li>
								...
								<li>ログイン完了後、トップページへ遷移する<br>初回登録時に会員詳細情報を登録していなければ、自動的に<a href="#2">会員詳細情報編集</a>ページへ遷移する</li>
							</ol>
					...
					<div id="2">
						...
						<div id="21">
							<h3>会員詳細情報編集</h3>
							<h4>個人ステータスの登録</h4>
							　この項目は、Facebook連帯ログインの場合表示されません
							<ul>
								<li>会員番号：あなたの会員番号</li>
								<li>性別：あなたの性別を選択</li>
								<li>年代：あなたの年代を選択</li>
					...
					<div id="3">
						...
						<div id="31">
							...
							<p>地図内左側の「>>」ボタンを押すと凡例が表示されます。凡例内のチェックボックスより、凡例ごとのマーカの表示/非表示を切り替えることができます。</p>
							<ol>
								<li>地図上のマーカを押す</li>
								<li>出てきたポップの項目の中の「詳細」を押す</li>
							</ol>
						</div>
						<br>
						<div id="32">

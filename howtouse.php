				...
				<div class="contentswrap">
					...
					<div id="3">
						...
						<div id="31">
							<h3>観光スポットの選択</h3>
							<ol>
								<li>カテゴリーを選択してクリックをしてください。<br>なお、「その他」にはイベント情報等が分類されています。</li>
					...
					<div id="4">
						...
						<div id="42"><h3>推薦された観光スポットの表示</h3>
							<p>あなたにおすすめする観光スポットが表示されます。<br>地図上にあるマーカーをクリックすると
								...
								が地図上に表示されます。<br>
								<font color="red">(注意) 画面をスクロールしてから地図をクリックすると正常な位置にポップが表示されません</font><br>
								また、地図の下のテーブル内には「推薦スポット一覧」を表示しております<br>
								テーブル内の名前のリンクからも<a href="#32">詳細情報</a>へ飛ぶことができます。
							</p>
							マーカーの凡例

				...
				<div id="1">
					...
					<div id="3">
						...
						<div id="31">
							<h3>観光スポットの選択</h3>
							<ol>
								<li>カテゴリーを選択し、送信してください。カテゴリー<br>
								なお、「その他」にはイベント情報等が分類されています。</li>
						...
						<div id="33">
							...
							<p>行ったことのある観光スポットについて、下記の項目に従って評価をお願いします。<br>
							この評価情報は観光スポットを推薦するための評価値として使われます。</p>
							<ul>
								<li>満足度　　　　　　　：(1)低い　　　　<--->(5)高い</li>
								<li>アクセス　　　　　　：(1)困難　　　　<--->(5)容易</li>
								<li>人混みの少なさ　　　：(1)少ない　　　<--->(5)多い</li>
					...
					<div id="4">
						...
						<ol>
							<li>観光するグループを選択してください。<br>
							<a href="#22">グループ編集</a>で登録したグループが表示されます。<br>
							<font color="red">グループが未登録の場合は「一人」しか選択できません。</font></li>
							<li>推薦して欲しい観光スポットのカテゴリーを選択してください。<br>
							なお、「その他」にはイベント情報等が分類されています。</li>
							<li>観光の際に重視する項目を１つ選択してください。<br>
							初期値は「何も重視しない」となっております。</li>
						</ol>
						<a class="button" href="#index">▲ 目次に戻る</a>
					</div>
				</div>
